...
public final class StandardDubeolsik: KoreanIME {
    ...
    private static func createLayout() -> [String: VirtualKey] {
        [
            // 일반 키
            "1": VirtualKey(keyIdentifier: "1", label: "1"),
            "2": VirtualKey(keyIdentifier: "2", label: "2"),
            "3": VirtualKey(keyIdentifier: "3", label: "3"),
            "4": VirtualKey(keyIdentifier: "4", label: "4"),
            "5": VirtualKey(keyIdentifier: "5", label: "5"),
            "6": VirtualKey(keyIdentifier: "6", label: "6"),
            "7": VirtualKey(keyIdentifier: "7", label: "7"),
            "8": VirtualKey(keyIdentifier: "8", label: "8"),
            "9": VirtualKey(keyIdentifier: "9", label: "9"),
            "0": VirtualKey(keyIdentifier: "0", label: "0"),
            ...
            ".": VirtualKey(keyIdentifier: ".", label: "."),
            "/": VirtualKey(keyIdentifier: "/", label: "/"),
            " ": VirtualKey(keyIdentifier: " ", label: " "), // 스페이스
            "~": VirtualKey(keyIdentifier: "~", label: "~"),
            "!": VirtualKey(keyIdentifier: "!", label: "!"),
            "@": VirtualKey(keyIdentifier: "@", label: "@"),
            "#": VirtualKey(keyIdentifier: "#", label: "#"),
            ...
            "(": VirtualKey(keyIdentifier: "(", label: "("),
            ")": VirtualKey(keyIdentifier: ")", label: ")"),
            "_": VirtualKey(keyIdentifier: "_", label: "_"),
            "+": VirtualKey(keyIdentifier: "+", label: "+"),
            "{": VirtualKey(keyIdentifier: "{", label: "{"),
            "}": VirtualKey(keyIdentifier: "}", label: "}"),
            "|": VirtualKey(keyIdentifier: "|", label: "|"),

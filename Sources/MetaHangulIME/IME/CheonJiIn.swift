...
public final class CheonJiIn: KoreanIME {
    ...
    private static func createDokkaebiAutomaton() -> DokkaebiAutomaton {
        ...
        // 표준 도깨비불 분리 (중성-도깨비불)
        automaton.addJungseongTransition(jongseongState: "ㄳ", remainingJong: "ㄱ", movedCho: "ㅅ")
        automaton.addJungseongTransition(jongseongState: "ㄵ", remainingJong: "ㄴ", movedCho: "ㅈ")
        automaton.addJungseongTransition(jongseongState: "ㅀ", remainingJong: "ㄴ", movedCho: "ㅎ")
        automaton.addJungseongTransition(jongseongState: "ㄺ", remainingJong: "ㄹ", movedCho: "ㄱ")
        automaton.addJungseongTransition(jongseongState: "ㄻ", remainingJong: "ㄹ", movedCho: "ㅁ")
        automaton.addJungseongTransition(jongseongState: "ㄼ", remainingJong: "ㄹ", movedCho: "ㅂ")
        automaton.addJungseongTransition(jongseongState: "ㄽ", remainingJong: "ㄹ", movedCho: "ㅅ")
        automaton.addJungseongTransition(jongseongState: "ㄾ", remainingJong: "ㄹ", movedCho: "ㅌ")
        automaton.addJungseongTransition(jongseongState: "ㄿ", remainingJong: "ㄹ", movedCho: "ㅍ")
        automaton.addJungseongTransition(jongseongState: "ㅄ", remainingJong: "ㅂ", movedCho: "ㅅ")

        // 천지인을 위한 중간 상태
        automaton.addJungseongTransition(jongseongState: "ㄴㅅ", remainingJong: "ㄴ", movedCho: "ㅅ")
        automaton.addJungseongTransition(jongseongState: "ㄹㅇ", remainingJong: "ㄹ", movedCho: "ㅇ")
        automaton.addJungseongTransition(jongseongState: "ㄹㄷ", remainingJong: "ㄹ", movedCho: "ㄷ")
        automaton.addJungseongTransition(jongseongState: "ㄸ", remainingJong: "ㄷ", movedCho: "ㄷ")
        automaton.addJungseongTransition(jongseongState: "ㅃ", remainingJong: "ㅂ", movedCho: "ㅂ")
        automaton.addJungseongTransition(jongseongState: "ㅉ", remainingJong: "ㅈ", movedCho: "ㅈ")

        // 분리할 수 있는 단일 자음
        automaton.addJungseongTransition(jongseongState: "ㄱ", remainingJong: nil, movedCho: "ㄱ")
        automaton.addJungseongTransition(jongseongState: "ㄴ", remainingJong: nil, movedCho: "ㄴ")
        automaton.addJungseongTransition(jongseongState: "ㄷ", remainingJong: nil, movedCho: "ㄷ")
        automaton.addJungseongTransition(jongseongState: "ㄹ", remainingJong: nil, movedCho: "ㄹ")
        automaton.addJungseongTransition(jongseongState: "ㅁ", remainingJong: nil, movedCho: "ㅁ")
        automaton.addJungseongTransition(jongseongState: "ㅂ", remainingJong: nil, movedCho: "ㅂ")
        automaton.addJungseongTransition(jongseongState: "ㅅ", remainingJong: nil, movedCho: "ㅅ")
        automaton.addJungseongTransition(jongseongState: "ㅇ", remainingJong: nil, movedCho: "ㅇ")
        automaton.addJungseongTransition(jongseongState: "ㅈ", remainingJong: nil, movedCho: "ㅈ")
        automaton.addJungseongTransition(jongseongState: "ㅊ", remainingJong: nil, movedCho: "ㅊ")
        automaton.addJungseongTransition(jongseongState: "ㅋ", remainingJong: nil, movedCho: "ㅋ")
        automaton.addJungseongTransition(jongseongState: "ㅌ", remainingJong: nil, movedCho: "ㅌ")
        automaton.addJungseongTransition(jongseongState: "ㅍ", remainingJong: nil, movedCho: "ㅍ")
        automaton.addJungseongTransition(jongseongState: "ㅎ", remainingJong: nil, movedCho: "ㅎ")
        automaton.addJungseongTransition(jongseongState: "ㄲ", remainingJong: nil, movedCho: "ㄲ")
        automaton.addJungseongTransition(jongseongState: "ㅆ", remainingJong: nil, movedCho: "ㅆ")
